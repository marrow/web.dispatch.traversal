...
description = "Dictionary traversal; a method for WebCore to resolve URL components to Python objects using a dict/mapping."
copyright = "2009-2014, Alice Bevan-McGregor and contributors"
url = 'https://docs.webcore.io/dispatch/traversal'
