...
exec(open(os.path.join("web", "dispatch", "traversal", "release.py")).read())
...
setup(
	name = "WebCore.dispatch.traversal",
	version = version,
	
	description = description,
	long_description = codecs.open(os.path.join(here, 'README.rst'), 'r', 'utf8').read(),
	url = url,
	download_url = 'https://warehouse.python.org/project/WebCore.dispatch.traversal/',
	...
	entry_points = {
			'web.dispatch': [
					# Core
					'traversal = web.dispatch.traversal:TraversalDispatch',  # dictionary traversal
				],
		},
